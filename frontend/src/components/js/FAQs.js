		...
		<>
			<div className='text-white max-w-screen-xl mx-auto px-5 bg-lam-midnight min-h-sceen'>
				...
				<div className='grid divide-y divide-neutral-200 max-w-xl mx-auto mt-8'>
								...
								return (
									<div className='py-5'>
										<details className='group'>
											...
											font-medium cursor-pointer list-none
											text-lam-sand mt-3 group-open:animate-fadeIn'>
												{question.answer}
											</p> */}
										</details>
									</div>
					...
					{/* <div className='py-5'>
						<details className='group'>
							<summary className='text-white flex justify-between items-center font-medium cursor-pointer list-none'>
							...
							<p className='text-lam-sand mt-3 group-open:animate-fadeIn'>
